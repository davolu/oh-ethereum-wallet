      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <button
            ...
            className="flex mx-auto mt-6x text-white border-2 border-green-900 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded-3xl text-lg"
          >
            Import New Wallet
          </button>
          <select
            ...
            className="flex mx-auto mt-6x ml-3 text-color-green border-2 border-green-900 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded-3xl text-lg"
          >
